    ...
    <div id="projects" className="selectionProject">
      ...
      <div className="selectionProject-projeto">
        ...
        <div className="selectionProject-projeto-descricao">
          <h2>LocalInfo</h2>
          <p>
            LocalInfo é site de negócios locais feito por mim e minha equipe. Foi aplicado as tecnologias do MERN Stack e apresentado
            no trabalho final de conclusão de curso.
          </p>
