      ...
      <div className="sectionFormation-grid">
        <div className="sectionFormation-formacao">
          ...
          <div className="group">
            ...
            <p>
              Formado em Técnico em Desenvolvimento de Sistemas pelo SENAI de
              Feira de Santana, Bahia. Concluído em 2023.
            </p>
          </div>
        </div>
        ...
        <div className="sectionFormation-formacao">
          ...
          <div className="group">
            ...
            <p>
              Bolsa no curso de Full Stack pelo programa Desenvolve, uma
              iniciativa do Grupo Boticário na plataforma Alura.
            </p>
          </div>
        </div>
      </div>
